package com.jeecg.business.service.impl;
...
@Service("aProjectInfoService")
@Transactional
public class AProjectInfoServiceImpl extends CommonServiceImpl implements AProjectInfoServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(AProjectInfoEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(AProjectInfoEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(AProjectInfoEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(AProjectInfoEntity t){
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,AProjectInfoEntity t){
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("a_project_info",data);
				}
			} catch (Exception e) {
				e.printStackTrace();
