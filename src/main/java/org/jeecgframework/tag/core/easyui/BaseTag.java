...
//				sb.append("<script type=\"text/javascript\" src=\"plug-in/lhgDialog/lhgdialog.min.js"+("metro".equals(cssTheme)?"?skin=metro":"")+"\"></script>");
		...
		if (oConvertUtils.isIn("fileupload", types)) {
//			sb.append("<script type=\"text/javascript\" src=\"plug-in/fileupload/js/vendor/jquery.ui.widget.js\"></script>");
//			sb.append("<script type=\"text/javascript\" src=\"plug-in/fileupload/js/jquery.iframe-transport.js\"></script>");
//			sb.append("<script type=\"text/javascript\" src=\"plug-in/fileupload/js/jquery.fileupload.js\"></script>");
//			sb.append("<script type=\"text/javascript\" src=\"plug-in/fileupload/js/jquery.fileupload-process.js\"></script>");
//			sb.append("<script type=\"text/javascript\" src=\"plug-in/fileupload/js/jquery.fileupload-validate.js\"></script>");
//			sb.append("<link rel='stylesheet' href='plug-in/jquery-plugs/fileupload/css/jquery.fileupload.css'>");
//

			sb.append("<script type=\"text/javascript\" src=\"plug-in/jquery-plugs/fileupload/js/vendor/jquery.ui.widget.js\"></script>");
			sb.append("<script type=\"text/javascript\" src=\"plug-in/jquery-plugs/fileupload/js/jquery.iframe-transport.js\"></script>");
			sb.append("<script type=\"text/javascript\" src=\"plug-in/jquery-plugs/fileupload/js/jquery.fileupload.js\"></script>");
			sb.append("<script type=\"text/javascript\" src=\"plug-in/jquery-plugs/fileupload/js/jquery.fileupload-process.js\"></script>");
			sb.append("<script type=\"text/javascript\" src=\"plug-in/jquery-plugs/fileupload/js/jquery.fileupload-validate.js\"></script>");
			sb.append("<link rel='stylesheet' href='plug-in/jquery-plugs/fileupload/css/jquery.fileupload.css'>");
		}
		types = null;
